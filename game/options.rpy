...
define config.name = _("Shattered Memories Prototype")
...
define build.name = "ShatteredMemoriesPrototype"
...
define config.save_directory = "ShatteredMemoriesPrototype-1525738326"
